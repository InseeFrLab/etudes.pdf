...
région le 1ᵉʳ jour. L’attrait de la région semble toutefois s’étioler depuis 2019, encore davantage depuis l’épidémie de Covid. La perte d’attrait cible surtout les espaces urbains, alors que
...
qrcode: "_extensions/insee-flash/resources/images/qrcode.png" # mettre "" si pas de qrcode
...
content[
La population ligérienne est estimée à 3 965 000 habitants au\ 1#super[er] janvier 2026, soit une augmentation de 6,1 % depuis le\ 1#super[er] janvier 2016 (contre +3,7 % en France). Cette croissance est comparable à celle des régions de la façade atlantique et de la façade méditerranéenne, à l’exception de la Corse, seule région métropolitaine avec une croissance de population à deux chiffres sur la période ▶︎ figure 1.

= Pays de la Loire : un solde migratoire positif le 1#super[er] janvier 2026
...
En revanche, le solde des Pays de la Loire est déficitaire avec les régions métropolitaines les plus attractives. En particulier, les Ligériens partent de plus en plus vers la Bretagne, et le déficit d’attrait des Pays de la Loire se creuse : 88 arrivées pour 100 départs en 2021, contre 99 en 2015.#pt-insee() \
...
myfig(
  ...
  titre: "1. Nombre d’entrées pour 100 sorties et solde migratoire par région le 1" + super("er") + " jour",
...
myfig(
  pos: bottom + left, largeur: 49%, dx: 0mm, dy: -38mm, width-image: 100%,
  titre: "2. Flux et solde migratoires entre les Pays de la Loire et les autres régions métropolitaines en 2021",
  ...
  "_extensions/insee-flash/resources/images/if157_fig2.png"
)

mybloc(pos: bottom + right, largeur: 49%, dy: -20mm, dx: 0mm)[
#encadre(spacing: 1em,  leading: 0.6em)[
...
#pour-en-savoir-plus(spacing: 1.1em,  leading: 0.6em)[
  == Pour en savoir plus
...
// OURS
mybloc(pos: bottom , largeur: 100%, dy: 0mm,
pad-bottom: 0mm, pad-top: 0mm, pad-left: 0mm, pad-right: 0mm,)[
