...
test_that("L'arborescence des extensions Insee est complète", {
  ...
  expect_true(file.exists(here("inst/insee-analyses/resources/images/logoInseeFr.png")))
  expect_true(file.exists(here("inst/insee-analyses/resources/images/tetiere.png")))
  expect_true(file.exists(here("inst/insee-analyses/resources/images/logo_x.png")))
...
test_that("Le fichier de démonstration IA144 contient un YAML valide", {
  ...
  expect_equal(yaml_data$title, "L’activité économique ligérienne consomme 4 400 hectares de 2011 à 2020")
...
test_that("Le fichier de démonstration IF157 contient un YAML valide", {
  ...
  expect_equal(yaml_data$title, "L’attrait des Pays de la Loire montre des signes d’érosion")
